...
function Profile({ setChanged }) {
    ...
    return (
        <div className="Profile">
            <div className="keus-image" style={{display:"flex",flexDirection:"column",alignItems:"center"}}>
                <img src={Keusimage} alt="No" className="Keusimage" style={{paddingBottom:"0.5rem"}} />
